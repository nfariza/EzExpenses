...
public class AdapterMemberList extends RecyclerView.Adapter<AdapterMemberList.HolderParticipantAdd> {

    private Context context;
    private ArrayList<ModelUser> userList;
    private String groupId, myGroupRole; //creator/admin/member

    public AdapterMemberList(Context context, ArrayList<ModelUser> userList, String groupId, String myGroupRole) {
    ...
    public HolderParticipantAdd onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
        //inflate layout
        View view = LayoutInflater.from(context).inflate(R.layout.model_member_list, parent, false);
    ...
    class HolderParticipantAdd extends RecyclerView.ViewHolder{
        ...
        private TextView nameTv, emailTv, phoneTv, statusTv;
